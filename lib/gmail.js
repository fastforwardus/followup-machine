...
function buildRawEmail({ to, subject, htmlBody, inReplyTo, references, attachment }) {
...
export async function sendEmailWithAttachment({ to, subject, body, threadId, inReplyTo, references, attachment }) {
  const gmail = getGmailClient();
  const htmlBody = buildEmailHTML({ subject, body });
  const raw = buildRawEmail({ to, subject, htmlBody, inReplyTo, references, attachment });
